            ...
            <div class="container max-w-screen-xl mx-auto px-4">
                ...
                <div class="flex items-center justify-center">
                        ...
                        <div class="mt-28 text-center">
                            <h1 class="font-semibold text-4xl md:text-6xl lg:text-7xl text-gray-900 leading-normal mb-6">About Us</h1>

                            <div class="max-w-4xl mx-auto">
                                <p class="font-normal text-xl text-gray-400 leading-relaxed mb-12">
                                    <span class="font-semibold">Our Mission:</span>
                                ...
                                <p class="font-normal text-xl text-gray-400 leading-relaxed mb-12">
                                    <span class="font-semibold">Our History:</span>
                            ...
                            <button class="px-6 py-4 bg-blue-700 text-white font-semibold text-lg rounded-xl hover:bg-blue-900 transition ease-in-out duration-500">Start Your Journey</button>
                        </div>
                </div>
                ...
                <section class="bg-white py-50">
                    ...
                    <div class="container max-w-screen-xl mx-auto px-4 xl:relative">
                        ...
                        <h1 class="font-semibold text-gray-900 text-2xl md:text-4xl text-center leading-normal mb-14">What People Say <br /> About Canva</h1>

                        <div class="hidden xl:block xl:absolute top-0">
                            <img src="../../../../public/assets/images/testimoni-1.png" alt="Image" />
                        </div>

                        <div class="hidden xl:block xl:absolute top-32">
                            <img src="../../../../public/assets/images/testimoni-2.png" alt="Image" />
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-center md:space-x-8 lg:space-x-12 mb-10 md:mb-20">
                            ...
                            <div class="bg-gray-100 rounded-lg mb-10 md:mb-0">
                                <img src="../../../../public/assets/images/testimoni-3.png" alt="Image" class="mx-8 my-8" />
                                ...
                                <p class="font-normal text-sm lg:text-md text-gray-400 mx-8 my-8">flexible in pace and customizable by design. <br />You can study part time, choosing courses that fit your schedule<br /> and align with your professional goals.</p>

                                <h3 class="font-semibold text-gray-900 text-xl md:text-2xl lg:text-3xl mx-8 mb-8">Brooklyn Simmons</h3>
                            </div>

                            <div class="bg-gray-100 rounded-lg">
                                <img src="../../../../public/assets/images/testimoni-4.png" alt="Image" class="mx-8 my-8" />
                                ...
                                <p class="font-normal text-sm lg:text-md text-gray-400 mx-8 my-8">flexible in pace and customizable by design. You can study part time,<br /> choosing courses that fit your schedule and align with<br /> your professional goals.</p>
...
<script setup>
import Navbar from '@/Guest/Partials/Navbar.vue'
import Footer from '@/Guest/Partials/Footer.vue'
